...
// Funcion de ASM para leer el scancode raw del puerto del teclado
...
// Funcion que se llama desde el IRQ dispatcher
// Devuelve el char
void keyboard_handler(); 

// Funcion para que las aplicaciones/kernel obtengan un caracter del buffer
